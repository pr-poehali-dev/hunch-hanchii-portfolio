            ...
            <Card className="border-2 border-yellow-200 hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold text-purple-700 mb-2">Великое Основание</h3>
                    <p className="text-sm text-purple-500 mb-3">5000 лет назад</p>
                    <p className="text-purple-600 leading-relaxed">
                      Первые жители Хунч-Ханчии прибыли на Сатурн из далёкой галактики в поисках 
                      мира и гармонии. Они обнаружили, что кольца планеты обладают уникальной 
                      энергией, которая помогла им создать процветающую цивилизацию.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-2 border-purple-200 hover:shadow-xl transition-shadow">
              <CardContent className="p-8">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-semibold text-purple-700 mb-2">Эра Гармонии</h3>
                    <p className="text-sm text-purple-500 mb-3">3000 лет назад - настоящее время</p>
                    <p className="text-purple-600 leading-relaxed">
                      За тысячелетия жители построили удивительные парящие города, научились 
                      использовать энергию колец для создания произведений искусства и развили 
                      уникальную культуру, основанную на музыке и свете.
                    </p>
                  </div>
                </div>
              </CardContent>
